 ...
 * @public
 */
declare function areDeepEqual<TObject>(a: TObject, b: TObject): boolean;
 ...
 * @public
 */
declare function getHomeFolder(): string;
 ...
 * @public
 */
export declare interface IRunWithTimeoutOptions<TResult> {
    /**
 ...
 * @public
 */
export declare interface IWaitForExitResult<T extends Buffer | string = never> extends IWaitForExitResultWithoutOutput {
    /**
 ...
 * @public
 */
export declare interface IWaitForExitResultWithoutOutput {
    /**
 ...
 */
declare function polyfillDisposeSymbols(): void;

...
export const api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    fetchUserDetail: builder.mutation<any, void>({
      query: () => ({
        url: "user/detail/",
        method: "GET",
      }),
    ...
    getTryoutReview: builder.query<any, number>({
      query: (tryoutId) => `tryouts/${tryoutId}/result/`,
    }),

    // ========== PRACTICE TEST ==============
    getPracticeTests: builder.query<any, void>({
    ...
    getLatihanAll: builder.query<any[], void>({
      query: () => "latihan/",
    }),
    ...
    getCountdown: builder.query<any, void>({
      query: () => "countdown/",
    }),
    ...
    getTotalRanks: builder.query<any, void>({
      query: () => `rank/total/`,
    }),
    ...
    checkoutSubscription: builder.mutation<
      { token: string; order_id?: string; redirect_url?: string },
      { subscriptionId: number; amount: number }
    >({
